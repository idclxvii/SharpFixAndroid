...
public class DuplicateFilesScannerThread  implements Runnable{
	
	
	public DuplicateFilesScannerThread(){
	...
	public DuplicateFilesScannerThread(File f, String currentDir){
