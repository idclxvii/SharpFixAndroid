...
public class SubMenuFdActivity extends GlobalExceptionHandlerActivity implements OnClickListener{
	...
	public void onPause() {
 		...
 		super.onPause();
		if((ch.isChecked() && SF.getFdSwitch() == 0 ) ||
				(!ch.isChecked() && SF.getFdSwitch() == 1)){
			// update database 
			if(ch.isChecked()){
