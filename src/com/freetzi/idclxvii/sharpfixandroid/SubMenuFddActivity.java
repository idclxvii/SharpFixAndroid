...
import com.freetzi.idclxvii.sharpfixandroid.databasemodel.ModelPreferences;
import com.freetzi.idclxvii.sharpfixandroid.databasemodel.Tables;
			...
			if(ch.isChecked()){
				...
				try{
					ModelPreferences newParams = new ModelPreferences(((SharpFixApplicationClass) getApplication()).getAccountId(),
								...
								((SharpFixApplicationClass) getApplication()).getFilterSwitch(), ((SharpFixApplicationClass) getApplication()).getFddPref(),
